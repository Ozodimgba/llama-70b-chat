...
import { couponAddress, shopAddress, usdcAddress } from "@/data/addresses";
import calculatePrice from "@/utils/calculatePrice";
import base58 from "bs58";

// Define the types as needed
...
async function post(req, res) {
  try {
    ...
    // We must partially sign because the transfer instruction still requires the user
